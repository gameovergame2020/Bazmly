                    ...
                    <div className="relative">
                      <div className="flex border border-gray-300 rounded-lg overflow-hidden bg-white">
                        ...
                        <select
                          ...
                          className="flex-1 px-4 py-3 text-lg font-medium bg-transparent border-none outline-none focus:ring-0 cursor-pointer"
                          data-hours="true"
                          size={5}
                        >
                      ...
                      <style jsx>{`
                        ...
                        /* Limit dropdown options display */
                        select[data-hours]:focus,
                        select[data-hours]:active {
                          max-height: 150px;
                        }
                      `}</style>
